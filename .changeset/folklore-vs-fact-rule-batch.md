...
- **`tech/robots-txt-limits`** (warning/info) — robots.txt beyond Google's 500 KiB parse limit; unsupported directives, with `noindex:`-in-robots.txt escalated (ignored since 2019 — pages are NOT excluded).
