  ...
  return (
    <div className="flex max-w-xl flex-col gap-6">
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">Account-level configuration. Credentials live under API keys &amp; MCP; for per-domain settings, open a domain and click Settings.</p>
      </div>
