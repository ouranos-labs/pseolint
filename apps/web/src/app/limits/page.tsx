  ...
  return (
    <main className="mx-auto max-w-3xl px-5 pb-20 pt-14">
      ...
      <Section title="Scope — what we actually audit">
        ...
        <Item k="Cumulative coverage (Pro monitoring)" v="200 URLs per weekly cron tick, audited diff-aware: unchanged URLs carry forward their findings without a re-fetch. Over time, the cumulative URLs-audited count grows — coverage growth depends on the size and overlap of each weekly sample, so cumulative totals will be higher for sites with churn or large URL spaces and lower for small/stable sites. The per-domain dashboard shows the running total." />
